...
export default function SQLCertificationsLesson() {
  return (
    <div className="space-y-6">
      ...
      >
        <Sparkles size={12} /> Database Management Systems
      </p>
      ...
      <p className="text-sm leading-6" style={{ color: '#374151' }}>
        ...
        Every option below is completely free to earn (no credit card required). Recommended to complement your coursework and strengthen your CV and LinkedIn profile.
      </p>
