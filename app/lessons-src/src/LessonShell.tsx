...
// ─── Shared shell for the standalone, interactive lesson decks ──────────────
// Adapted from the original PublicLessonShell: same sticky nav, Apple-style
// hero with drifting colour orbs, lesson body, quiet footer. Navigation goes
// back to the host site's own #/lessons hash route instead of react-router,
// since this bundle is mounted as an island inside app/js/app.js's router.
...
interface LessonShellProps {
  /** Small uppercase line above the title, e.g. "Database Management Systems". */
  eyebrow: string;
...
export default function LessonShell({
  ...
  return (
    <div style={{ fontFamily: APPLE_FONT }} className="lessons-root min-h-screen bg-white text-[#1d1d1f]">
      {/* ── Top nav ── */}
      <nav className="sticky top-0 z-50 border-b border-black/[0.07] bg-white/90 backdrop-blur-xl">
        <div className="mx-auto flex max-w-5xl items-center justify-between px-6 py-3">
          <a href="#/lessons" className="no-underline">
      ...
      <footer className="border-t border-black/[0.06] px-6 py-12 text-center">
        ...
        <p className="mt-4">
          <a href="#/lessons" className="text-[13px] font-semibold" style={{ color: accent }}>
            ← Back to all lessons
          </a>
        </p>
      </footer>
